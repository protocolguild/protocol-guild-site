...
- 9 Working Groups, 38 contributors
...
#### Cryptography Research (7 contributors)

| Name | Weight | Contributions |
|:---|:---|:---|
...
#### Robust Incentive Group (RIG) (6 contributors)
...
#### Execution Layer Specs + Coordination (8 contributors)
...
#### Consensus Layer Specs + Coordination (4 contributors)
...
#### Hyperledger Besu (14 contributors)
...
**Guild Member (Anonymous)** - "The domain is inherently complicated, so there need to be incentive to attract capable developer. Relatively speaking, it also requires pretty beefy equipment (large capacity ssd) whose cost can add up."
