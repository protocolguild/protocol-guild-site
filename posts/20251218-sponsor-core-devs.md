---
title: 'Announcing: Sponsor a Core Dev'
excerpt: 'Protocol Guild is excited to launch the Sponsor a Core Dev funding program.'
coverImage: '/Sponsor-core-dev.png'
date: '2025-12-18'
---
...
-   implement clearer success metrics for covering specific funding gaps

-   supplement the meaningful funding facilitated through our first program, the 1% Pledge 

-   represent and celebrate a broader set of ecosystem contributions
...
While protocol contributors are often values-motivated, we cannot rely on that alone to retain the top-tier talent necessary to advance the protocol and steward it for the decades to come. This work includes:

-   maintaining and developing one of the 12 different execution and consensus clients: critical for maintaining Ethereum's 100% uptime

-   testing and security of any new protocol features: scaling the L1, scaling L2 data availability, and improving interop

-   researching future constructions: post-quantum security, faster finality, zkEVMs

### How "Sponsor a Core Dev" Works

To support this crucial work, we are introducing annual sponsorships at the scale of the individual contributor. It's a direct, transparent, and impactful way for the entire ecosystem to support its own foundation.
...
Corporations, DAOs and individuals are invited to participate, directly covering the compensation gap and making a powerful statement of support for shared software resources.

For projects that intend to introduce a protocol token, the 1% Pledge is still the best option. 

| Core devs Funded Annually | $ amount |
| :--- | :--- |
| 1 | $160k (covers funding gap for 1 member) |
| 2 | $320k |
| 4 | $640k |
| 1 team / 8 core devs | $1.28mm |
...
This new program expands on this success by providing a new, accessible entry point for community support.

We are currently gathering an initial cohort of funding partners to announce the program more formally in early 2026. If you or your organization are interested, please reach out to the team at hello@protocolguild.org or directly to one of the team members: Trent, Peter, or Cheeky.

Let's work together to ensure the brightest minds can continue to build the world computer! 🌐💻
