      ...
      <Section.Row className="relative z-1">
        <Grid>
          <Grid.Item span={12} className="relative flex">
            ...
            {/* Content container */}
            <div className="relative z-10 flex flex-col items-start pt-[175px] lg:pt-[200px] pb-[70px] lg:pb-[215px] w-full md:w-[65%]">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] tracking-[-1.44px] text-[var(--gray-dark)] mb-4">{donateContent.hero.title}</h1>
                <p className="text-lg leading-[23px] text-[var(--gray-mid)] mb-4">{donateContent.hero.subtitle1}</p>
            </div>
            {/* Navbar */}
        ...
        <Grid columns={12} className="py-16">
          <Grid.Item span={6} className="flex flex-col gap-4">
            ...
            <h2 className="!text-lg !font-normal !leading-[24px] !text-[var(--gray-dark)] flex items-center">
              <a href="https://tim.mirror.xyz/srVdVopOFhD_ZoRDR50x8n5wmW3aRJIrNEAkpyQ4_ng" target="_blank" rel="noopener noreferrer" className="flex items-center">
      ...
      <Section.Row align="start">
        <Grid columns={12} className="py-16">
          <Grid.Item span={6} className="flex flex-col gap-6">
            ...
            <h2 className="!text-lg !font-normal !leading-[24px] !text-[var(--gray-dark)]">{donateContent.donate.description1}</h2>
            <h2 className="!text-lg !font-normal !leading-[24px] !text-[var(--gray-dark)]">{donateContent.donate.description2}</h2>
          ...
          <Grid.Item span={6} className="flex flex-col gap-3">
            ...
            <DonorSectionDark4 theme="dark" type="Donors" className="max-w-[100%] lg:max-w-[90%] mx-auto" />
          </Grid.Item>
        </Grid>
      </Section.Row>
    </Section>
