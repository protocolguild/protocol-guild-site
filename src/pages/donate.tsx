...
<Section background="white" divider="var(--brand-primary)" line={true}>
  <Section.Row align="start">
    <Grid columns={12} className="py-16">
      ...
      {/* Features Row */}
      <Grid.Item span={12} className="grid grid-cols-3 gap-x-4 gap-y-6">
        ...
        <Section.Row align="start">
          <Grid columns={12} className="py-16">
            <Grid.Item span={6} className="flex flex-col gap-4">
              ...
              <h2 className="!text-lg mt-5 !font-normal !leading-[24px] !text-[var(--white)]">{donateContent.pledge.description}</h2>
        ...
        <Section.Row align="start">
          <Grid columns={12} className="py-16">
            <Grid.Item span={6} className="flex flex-col gap-6">
              <h2 className="text-3xl font-bold leading-[1.1] text-[var(--white)]">{donateContent.ecosystem.title}</h2>
            </Grid.Item>
            <Grid.Item span={6} className="flex flex-col gap-6">
              <div className="w-full flex flex-row justify-between items-center">
                <p className="text-[var(--white)] text-base sm:text-sm">{donateContent.ecosystem.table.title}</p>
        ...
        <Section.Row align="start" >
          <Grid columns={12} className="py-16">
            <Grid.Item span={6} className="flex flex-col gap-4">
              ...
              <h2 className="!text-lg mt-5 !font-normal !leading-[24px] !text-[var(--white)]">{donateContent.planning.description}</h2>
            ...
            <Grid.Item span={6} className="flex flex-col">
              <h2 className="!text-lg mt-5 !font-normal !leading-[24px] !text-[var(--white)] italic">{donateContent.planning.quote}</h2>
            </Grid.Item>
          </Grid>
        </Section.Row>
      </Section>
      ...
      <Section background="gray-dark" divider="var(--brand-primary)" line={true}>
        <Section.Row align="start" >
          <Grid columns={12} className="py-16">
            <Grid.Item span={6} className="flex flex-col gap-6">
              <h2 className="text-3xl font-bold leading-[1.1] text-[var(--white)]">{donateContent.donate.title}</h2>
              <h2 className="!text-lg mt-5 !font-normal !leading-[24px] !text-[var(--white)]">{donateContent.donate.description}</h2>
