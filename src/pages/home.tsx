      ...
      <Section.Row className="relative z-1">
        <Grid>
          <Grid.Item span={12} className="relative flex">
            ...
            {/* Content container */}
            <div className="relative z-10 flex flex-col items-start pt-[200px] pb-[130px] w-full md:w-[65%]">
            <div className="relative z-10 flex flex-col items-start pt-[200px] pb-[70px] md:pb-[130px] w-full md:w-[65%]">
