...
return (
  <main>
    <Section background="white" className="flex flex-col pb-20 md:pb-16 mt-0 relative overflow-hidden">
      <Section.Row>
        <Grid>
      ...
      <Section.Row className="flex-1 flex items-center justify-center relative z-1 md:pb-15">
        <Grid>
