        ...
        <Section.Row align="start">
          <Grid columns={12} className="py-16">
            <Grid.Item span={6} className="flex flex-col gap-6">
              ...
              <h2 className="!text-lg mt-5 !font-bold !leading-[24px] !text-[var(--gray-dark)]">{aboutContent.funding.description2}</h2>
              <h2 className="!text-lg mt-5 !font-normal !leading-[24px] !text-[var(--gray-dark)]">{aboutContent.funding.description3}</h2>
              <h2 className="!text-lg mt-5 !font-bold !leading-[24px] !text-[var(--gray-dark)]">{aboutContent.funding.description4}</h2>
