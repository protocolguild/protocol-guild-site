                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="flex flex-col items-start">
                      ...
                      <div className="mt-2 flex flex-col items-start w-full gap-1">
                        ...
                        <a href="https://x.com/trent_vanepps" target="_blank" rel="noopener noreferrer" className="text-[var(--gray-dark)]">@trent_vanepps</a>
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <div className="mt-2 flex flex-col items-start w-full gap-1">
                        ...
                        <a href="https://x.com/cheekygorilla0x" target="_blank" rel="noopener noreferrer" className="text-[var(--gray-dark)]">@cheekygorilla0x</a>
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <div className="mt-2 flex flex-col items-start w-full gap-1">
                        ...
                        <a href="https://x.com/AlphaLemonade" target="_blank" rel="noopener noreferrer" className="text-[var(--gray-dark)]">@AlphaLemonade</a>
