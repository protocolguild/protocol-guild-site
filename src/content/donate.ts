  ...
  value: {
    ...
    features: [
      ...
      },
      {
        ...
        description: "Protocol Guild is the easiest and highest-signal way to support 190 core contributors across 47 core Ethereum repositories, from research to client implementations."
      },
      {
